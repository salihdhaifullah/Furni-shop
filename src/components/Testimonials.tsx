        ...
        <div className="pt-14">
            ...
            <div className="flex justify-center items-center flex-col gap-6">
                ...
                <div className="relative">
                    <div id="testimonial-go-back" className="absolute lg:-left-16 -left-8 top-1/2 bottom-1/2 z-20 hover:bg-primary shadow-md bg-white rounded-full cursor-pointer w-9 h-9 text-2xl hover:text-white text-primary sm:flex hidden items-center justify-center">
                        <IoIosArrowBack />
                    </div>

                    <div id="scroll-container" className="relative xl:w-[972px] md:w-[648px] w-[324px] overflow-x-auto hide-scroll-bar">
                        <div id="total-container" className="flex flex-row py-10 relative w-[1620px] gap-6 px-3">
                            {testimonials.map((testimonial, index) => (
                                <div key={index} id={`testimonial-${index}`} className="flex gap-4 flex-col w-[300px] bg-white rounded-md shadow-md p-4 justify-center items-center">
                    ...
                    <div id="testimonial-go-forward" className="absolute lg:-right-16 -right-8 top-1/2 bottom-1/2 z-20 hover:bg-primary shadow-md bg-white rounded-full cursor-pointer w-9 h-9 text-2xl hover:text-white text-primary sm:flex hidden items-center justify-center">
                        <IoIosArrowForward />
                    </div>
